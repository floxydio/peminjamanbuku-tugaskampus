...
<body id="page-top">
    ...
    <div class="alert alert-success alert-block" x-data="{show: true}" x-init="setTimeout(() => show = false, 2000)" x-show="show">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Buku</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$sss->count()}}</div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Peminjam</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$historyUser->count()}}</div>
                                        </div>
                                        <div class="col-auto">
